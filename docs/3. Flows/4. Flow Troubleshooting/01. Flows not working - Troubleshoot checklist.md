...
13.  ** Incorrect Interactive Message -** Check if the flow is started with an Interactive message. If yes, then see if there is any error shown in the chat screen for the error. Like in this case message body is missing in the interactive message.

<img width="891" alt="Screenshot 2023-06-05 at 12 43 44 PM" src="https://github.com/glific/docs/assets/16541548/7c6d1247-97c9-4ce1-90d2-97a3725a940f">
