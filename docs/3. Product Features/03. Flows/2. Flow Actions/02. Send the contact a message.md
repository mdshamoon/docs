...
Refer [Flow level & Contact level variables](https://glific.github.io/docs/docs/Flows/Flow%20Variables/Flow%20variables%20vs%20Contact%20variables/) to know more about how to use variables in flow.
...
**[Upload the files on GCS](https://glific.github.io/docs/docs/Integrations/How%20to%20upload%20files%20on%20GCS/)** and use the URL as attachment in multiple flow.
