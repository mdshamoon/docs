...
1) Go to your `Glific login URL`.It will look something like this:(https://prod.glific.com/login).
...
3) Enter your personal whatsapp number and click on `Genreate OTP to confirm`the verification code will be sent to your personal whatsapp number.

<img width="1453" alt="image" src="https://github.com/user-attachments/assets/3e763f4d-d067-43fd-a459-76c763abe59a" />


4) Enter the `personal whatsapp number`,`verification code` and `generate the new password` and `save` it.

<img width="1461" alt="image" src="https://github.com/user-attachments/assets/1a765ba4-b97f-4d2f-b1b0-0a879190d873" />

5) Once it's saved, log in to the Glific platform.
