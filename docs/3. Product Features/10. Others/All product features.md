...
1. [**Design conversations**](https://glific.github.io/docs/docs/Onboarding/Glific%20Pilot%20NGO%20Onboarding%20Toolkit/) - You can set up messages to be sent to the users and plan the next messages based on their responses. You can also take a lot of other actions based on users&#39; responses as mentioned below.
1. [**Send message to a staff**](https://glific.github.io/docs/docs/Flows/Flow%20Actions/Send%20message%20to%20a%20staff%20member/) - If you feel that your staff needs to be notified of something while a contact is in the middle of the flow.
1. **Terminate flow** - if a user is in a flow and you want to send a manual message you can terminate the active flow
1. [**Label a message**](https://glific.github.io/docs/docs/Flows/Flow%20Actions/Flow%20actions%20in%20Glific) - if you want to track some metrics, labels are your good friends. For example you want to see how many started a flow and how many completed the flow, you can label the first message as `Flow stared` and last message at `Flow completed`.
1. [**Wait for the next message**](https://glific.github.io/docs/docs/Flows/Flow%20Actions/Flow%20actions%20in%20Glific) - you can add pauses in between messages to make it look like a more natural conversation.
1. [**Split conversation paths**](https://glific.github.io/docs/docs/Flows/Flow%20Actions/How%20to%20use%20Split%20By%20Collection%20in%20Flow%20editor/) - you can send different contacts down different conversation paths based on multiple conditions for example, the collection they belong to and an option they selected.
1. [**Webhooks**](https://glific.github.io/docs/docs/Integrations/How%20to%20use%20Webhooks%20in%20Glific/) - use these when you want to interact with an external system to pull or push data from Glific.
...
## [Advanced Search](https://glific.github.io/docs/docs/Product%20Features/Dynamic%20search%20for%20contacts%20in%20Glific/)
...
## [HSM templates](https://glific.github.io/docs/docs/Product%20Features/HSM%20Templates/)
...
## [Interactive messages](https://glific.github.io/docs/docs/Flows/Flow%20Actions/How%20to%20use%20the%20Interactive%20Message%20in%20Flow%20editor/)
...
## [Time based scheduling (triggers)](https://glific.github.io/docs/docs/Product%20Features/Triggers%20in%20Glific/)
...
## [Default messaging](https://glific.github.io/docs/docs/Product%20Features/New%20Contact,%20Default%20flow%20Out%20of%20office%20hours%20notifications/#configure-default-flow)
...
## [Staff management (roles &amp; permissions)](https://glific.github.io/docs/docs/Product%20Features/Managing%20staff%20members/)
...
## [Collections](https://glific.github.io/docs/docs/Product%20Features/How%20are%20Collections%20used%20in%20Glific/)
...
## [Optin Management](https://glific.github.io/docs/docs/Flows/Flow%20Actions/Configure%20Optin%20&%20Optout%20preferences%20in%20Glific/)
...
## [Contact history](https://glific.github.io/docs/docs/Product%20Features/View%20contact%20profile%20and%20history/)
...
## [Multiple profiles](https://glific.github.io/docs/docs/Flows/Flow%20Features/Multiple%20Contactsprofiles%20with%20one%20phone%20number/)
...
## [Maps visualisation](https://glific.github.io/docs/docs/Flows/Flow%20Actions/How%20to%20use%20the%20Has%20location%20Category%20in%20Flow%20editor/)
...
## [Notifications](https://glific.github.io/docs/docs/How%20do%20I.../Notifications%20for%20system%20errors/)
...
## [Google sheet](https://glific.github.io/docs/docs/Flows/Flow%20Features/Integrate%20Google%20sheets%20in%20Flows/)
...
## [Access data with BigQuery](https://glific.github.io/docs/docs/Integrations/BigQuery%20Setup%20and%20link%20with%20Glific/)
...
## [NLP with Dialogflow](https://glific.github.io/docs/docs/Integrations/Getting%20started%20with%20Dialog%20Flow%20for%20NLP/)
