...
Once you have made a copy of the existing reports and made connections to your data sources by following the steps in this report - **** [**Integrate DataStudio to create visualisations &amp; reports**](https://glific.github.io/docs/docs/Reporting%20and%20Analytics/Integrate%20DataStudio%20to%20create%20visualizations%20&%20reports/)  **,** you are now all set to customise existing pages or add new pages.
