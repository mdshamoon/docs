...
b. **Verify Your Facebook Business Manager Page:** Facebook verification is an essential step in setting up your WhatsApp chatbot. Facebook Business
 Manager verification proves your business is genuine before you can use the WhatsApp Business API to run a WhatsApp chaPlease have any 
**two of the following documents** ready for upload- one to verify the legal name and another to confirm the legal address.
